...
async function createInitialProducts(){
    try{
        ...
        const waves = await createProduct({title:'Waves',description:'BEACH BEACH ', price:25.00, quantity:454,imageUrl:"http://www.impawards.com/2019/posters/waves_ver2.jpg"})
