...
async function createInitialProducts(){
    try{
        ...
        const saveYourselves =await createProduct({title:'Save Yourselves',description:'',price:23.00,quantity:2001,imageUrl:"https://images.squarespace-cdn.com/content/v1/582b5029bebafb10ec217bdf/1615830666374-4U5SQRFJMU12E8F5HCQ4/SaveYourselves_rgb.jpg?format=1500w"})
        const tampopop = await createProduct({title:'Tampopo',description:'',price:20.00,quantity:5,imageUrl:"https://upload.wikimedia.org/wikipedia/en/thumb/0/00/Tampopo_-_Poster.jpg/220px-Tampopo_-_Poster.jpg"})
        const fmf = await createProduct({title:'Fantastic Mr.Fox',description:'',price:32.00,quantity:324, imageUrl:"https://www.tvguide.com/a/img/catalog/provider/1/2/1-4493722784.jpg"})
