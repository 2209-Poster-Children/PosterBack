...
async function createInitialProducts(){
    try{
        ...
        const spaceInv = await createProduct({title:'Space Invaders', description:'INVADE INVADE', quantity:34.00,price:300,imageUrl:' a559cef86e786068ae156e7686d7c639.jpg',categoryId:videogames.id})
        const tetris = await createProduct({title:'Tetris', description:'Stacks on Stacks',price:21 ,quantity:23.00,imageUrl:' 138742.jpg', categoryId:videogames.id})
