...
async function createInitialProducts(){
    try{
        ...
        const tetris = await createProduct({title:'Tetris', description:'Stacks on Stacks',price:21 ,quantity:23.00,imageUrl:'https://imgur.com/AH2PRWw', categoryId:videogames.id})
        ...
        const eldenRing= await createProduct({title:'Elden Ring', description:'Mason', price:21.09, quantity:90,imageUrl:'https://imgur.com/vZqlFPG',categoryId:videogames.id})
        ...
        const pokemon = await createProduct({title:'Pokemon', description:'Catch them ALL',price:12.00, quantity:90, imageUrl:'https://imgur.com/bUJwHHa',categoryId:videogames.id})
